...
CITY_ABBRS = {"ST": "SAINT", "MT": "MOUNT", "FT": "FORT", "VA": "VIRGINIA"}
...
ADDRESS_KEYS = ("address_line_1", "address_line_2", "city", "state", "postal_code")
    ...
    if config:
        ...
        for key in addr_constants:
            ...
            if key == "OCCUPANCY_TYPE_ABBREVIATIONS" and new_vals:
                ...
                globals()["ABNORMAL_OCCUPANCY_ABBRVS"] = set(new_keys) - set(org_keys)
